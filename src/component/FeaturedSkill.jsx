    ...
    <>
      <div className="grid grid-cols-3 gap-10 mx-0 lg:mx-10 ml:mx-0 lg:grid-cols-2 xs:gap-5 2xs:gap-2 3xs:flex 3xs:flex-col">
        <div
          ...
          className="bg-blue-400 p-4 rounded-xl flex flex-col items-center justify-center cursor-pointer border-[1px] border-black max-h-[500px]"
        >
        ...
        <div
          ...
          className="bg-orange p-4 rounded-xl flex flex-col items-center justify-center cursor-pointer border-[1px] border-black  max-h-[500px]"
        >
          <div className="text-white h-1/5 flex items-center justify-center text-lg font-semibold 2xs:text-md text-center mb-5">
        ...
        <div
          ...
          className="bg-purple-600 p-4 rounded-xl flex flex-col items-center justify-center cursor-pointer border-[1px] border-black  max-h-[500px]"
        >
          <div className="text-white h-1/5 flex items-center justify-center text-lg font-semibold 2xs:text-md text-center mb-5">
            Connect Four Game
          </div>
        ...
        <div
          ...
          className="bg-indigo-600 p-4 rounded-xl flex flex-col items-center justify-center cursor-pointer border-[1px] border-black  max-h-[500px]"
        >
          <div className="text-white h-1/5 flex items-center justify-center text-lg font-semibold 2xs:text-md text-center mb-5">
            Multi Step Form
          </div>
